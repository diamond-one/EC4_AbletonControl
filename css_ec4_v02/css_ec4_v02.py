...
try:
	...
	pass
class css_ec4_v02(ControlSurface):
	def __init__(self, c_instance):
		super(css_ec4_v02, self).__init__(c_instance)
	...
	def midi_cc_ch_0_val_0_mode1_listener(self, value):
		...
		self.pick_brain(self.deon_id_14)
	...
	def midi_cc_ch_0_val_1_mode1_listener(self, value):
		...
		self.pick_brain(self.thrs_id_6)
	...
	def midi_cc_ch_0_val_2_mode1_listener(self, value):
		...
		self.pick_brain(self.rati_id_9)
	...
	def midi_cc_ch_0_val_3_mode1_listener(self, value):
		...
		self.pick_brain(self.knee_id_13)
	...
	def midi_cc_ch_0_val_4_mode1_listener(self, value):
		...
		self.pick_brain(self.atck_id_12)
	...
	def midi_cc_ch_0_val_5_mode1_listener(self, value):
		...
		self.pick_brain(self.rels_id_8)
	...
	def midi_cc_ch_0_val_6_mode1_listener(self, value):
		...
		self.pick_brain(self.arof_id_11)
	...
	def midi_cc_ch_0_val_7_mode1_listener(self, value):
		...
		self.pick_brain(self.expn_id_10)
	...
	def midi_cc_ch_0_val_8_mode1_listener(self, value):
		...
		self.pick_brain(self.outg_id_21)
	...
	def midi_cc_ch_0_val_9_mode1_listener(self, value):
		...
		self.pick_brain(self.make_id_20)
	...
	def midi_cc_ch_0_val_10_mode1_listener(self, value):
		...
		self.pick_brain(self.dryw_id_7)
	...
	def midi_cc_ch_0_val_11_mode1_listener(self, value):
		...
		self.pick_brain(self.modl_id_19)
	...
	def midi_cc_ch_0_val_13_mode1_listener(self, value):
		...
		self.pick_brain(self.scln_id_18)
	...
	def midi_cc_ch_0_val_12_mode1_listener(self, value):
		...
		self.pick_brain(self.scon_id_17)
	...
	def midi_cc_ch_0_val_14_mode1_listener(self, value):
		...
		self.pick_brain(self.scgn_id_16)
	...
	def midi_cc_ch_0_val_15_mode1_listener(self, value):
		...
		self.pick_brain(self.scmx_id_15)
	...
	def _mode1_configs(self):
		self.mode_1_configs_map = [
			...
			"scmx_id_15"]
		self.deon_id_14 = {}
		self.deon_id_14["attached_to"] = "midi_cc_ch_0_val_0"
		self.deon_id_14["track"] = self.track_num(2)
		self.deon_id_14["module"] = "self.song().view.selected_track.devices[self.get_modifier_value(\"m1\")].parameters[0]"
		self.deon_id_14["element"] = "value"
		self.deon_id_14["output_type"] = "val"
		self.deon_id_14["minimum"] = round(0,2)
		self.deon_id_14["maximum"] = round(100,2)
		self.deon_id_14["decimal_places"] = 2
		self.deon_id_14["ui_listener"] = "value"
		self.deon_id_14["feedback_brain"] = "feedback_range"
		self.deon_id_14["ctrl_type"] = "absolute"
		self.deon_id_14["enc_first"] = 126
		self.deon_id_14["enc_second"] = 127
		self.deon_id_14["reverse_mode"] = False
		self.deon_id_14["takeover_mode"] = "None"
		self.deon_id_14["steps"] = 127
		self.deon_id_14["LED_mapping_type_needs_feedback"] = "1"
		self.deon_id_14["LED_feedback"] = "default"
		self.deon_id_14["LED_feedback_active"] = "1"
		self.deon_id_14["LED_on"] = "127"
		self.deon_id_14["LED_off"] = "0"
		self.deon_id_14["LED_send_feedback_to_selected"] = ["midi_cc_ch_0_val_0"]
		self.deon_id_14["snap_to"] = True
		self.deon_id_14["json_id"] = 14
		self.deon_id_14["mapping_name"] = "DEON"
		self.deon_id_14["mapping_type"] = "Parameter"
		self.thrs_id_6 = {}
		self.thrs_id_6["attached_to"] = "midi_cc_ch_0_val_1"
		self.thrs_id_6["track"] = self.track_num(2)
		self.thrs_id_6["module"] = "self.song().view.selected_track.devices[self.get_modifier_value(\"m1\")].parameters[1]"
		self.thrs_id_6["element"] = "value"
		self.thrs_id_6["output_type"] = "val"
		self.thrs_id_6["minimum"] = round(0,2)
		self.thrs_id_6["maximum"] = round(100,2)
		self.thrs_id_6["decimal_places"] = 2
		self.thrs_id_6["ui_listener"] = "value"
		self.thrs_id_6["feedback_brain"] = "feedback_range"
		self.thrs_id_6["ctrl_type"] = "absolute"
		self.thrs_id_6["enc_first"] = 0
		self.thrs_id_6["enc_second"] = 127
		self.thrs_id_6["reverse_mode"] = False
		self.thrs_id_6["takeover_mode"] = "Value scaling"
		self.thrs_id_6["steps"] = 127
		self.thrs_id_6["LED_mapping_type_needs_feedback"] = "1"
		self.thrs_id_6["LED_feedback"] = "default"
		self.thrs_id_6["LED_feedback_active"] = "1"
		self.thrs_id_6["LED_on"] = "127"
		self.thrs_id_6["LED_off"] = "0"
		self.thrs_id_6["LED_send_feedback_to_selected"] = ["midi_cc_ch_0_val_1"]
		self.thrs_id_6["snap_to"] = False
		self.thrs_id_6["json_id"] = 6
		self.thrs_id_6["mapping_name"] = "THRS"
		self.thrs_id_6["mapping_type"] = "Parameter"
		self.rati_id_9 = {}
		self.rati_id_9["attached_to"] = "midi_cc_ch_0_val_2"
		self.rati_id_9["track"] = self.track_num(2)
		self.rati_id_9["module"] = "self.song().view.selected_track.devices[self.get_modifier_value(\"m1\")].parameters[2]"
		self.rati_id_9["element"] = "value"
		self.rati_id_9["output_type"] = "val"
		self.rati_id_9["minimum"] = round(0,2)
		self.rati_id_9["maximum"] = round(100,2)
		self.rati_id_9["decimal_places"] = 2
		self.rati_id_9["ui_listener"] = "value"
		self.rati_id_9["feedback_brain"] = "feedback_range"
		self.rati_id_9["ctrl_type"] = "absolute"
		self.rati_id_9["enc_first"] = 0
		self.rati_id_9["enc_second"] = 127
		self.rati_id_9["reverse_mode"] = False
		self.rati_id_9["takeover_mode"] = "Value scaling"
		self.rati_id_9["steps"] = 127
		self.rati_id_9["LED_mapping_type_needs_feedback"] = "1"
		self.rati_id_9["LED_feedback"] = "default"
		self.rati_id_9["LED_feedback_active"] = "1"
		self.rati_id_9["LED_on"] = "127"
		self.rati_id_9["LED_off"] = "0"
		self.rati_id_9["LED_send_feedback_to_selected"] = ["midi_cc_ch_0_val_2"]
		self.rati_id_9["snap_to"] = True
		self.rati_id_9["json_id"] = 9
		self.rati_id_9["mapping_name"] = "RATI"
		self.rati_id_9["mapping_type"] = "Parameter"
		self.knee_id_13 = {}
		self.knee_id_13["attached_to"] = "midi_cc_ch_0_val_3"
		self.knee_id_13["track"] = self.track_num(2)
		self.knee_id_13["module"] = "self.song().view.selected_track.devices[self.get_modifier_value(\"m1\")].parameters[12]"
		self.knee_id_13["element"] = "value"
		self.knee_id_13["output_type"] = "val"
		self.knee_id_13["minimum"] = round(0,2)
		self.knee_id_13["maximum"] = round(100,2)
		self.knee_id_13["decimal_places"] = 2
		self.knee_id_13["ui_listener"] = "value"
		self.knee_id_13["feedback_brain"] = "feedback_range"
		self.knee_id_13["ctrl_type"] = "absolute"
		self.knee_id_13["enc_first"] = 0
		self.knee_id_13["enc_second"] = 127
		self.knee_id_13["reverse_mode"] = False
		self.knee_id_13["takeover_mode"] = "Value scaling"
		self.knee_id_13["steps"] = 127
		self.knee_id_13["LED_mapping_type_needs_feedback"] = "1"
		self.knee_id_13["LED_feedback"] = "default"
		self.knee_id_13["LED_feedback_active"] = "1"
		self.knee_id_13["LED_on"] = "127"
		self.knee_id_13["LED_off"] = "0"
		self.knee_id_13["LED_send_feedback_to_selected"] = ["midi_cc_ch_0_val_3"]
		self.knee_id_13["snap_to"] = True
		self.knee_id_13["json_id"] = 13
		self.knee_id_13["mapping_name"] = "KNEE"
		self.knee_id_13["mapping_type"] = "Parameter"
		self.atck_id_12 = {}
		self.atck_id_12["attached_to"] = "midi_cc_ch_0_val_4"
		self.atck_id_12["track"] = self.track_num(2)
		self.atck_id_12["module"] = "self.song().view.selected_track.devices[self.get_modifier_value(\"m1\")].parameters[4]"
		self.atck_id_12["element"] = "value"
		self.atck_id_12["output_type"] = "val"
		self.atck_id_12["minimum"] = round(0,2)
		self.atck_id_12["maximum"] = round(100,2)
		self.atck_id_12["decimal_places"] = 2
		self.atck_id_12["ui_listener"] = "value"
		self.atck_id_12["feedback_brain"] = "feedback_range"
		self.atck_id_12["ctrl_type"] = "absolute"
		self.atck_id_12["enc_first"] = 0
		self.atck_id_12["enc_second"] = 127
		self.atck_id_12["reverse_mode"] = False
		self.atck_id_12["takeover_mode"] = "Value scaling"
		self.atck_id_12["steps"] = 127
		self.atck_id_12["LED_mapping_type_needs_feedback"] = "1"
		self.atck_id_12["LED_feedback"] = "default"
		self.atck_id_12["LED_feedback_active"] = "1"
		self.atck_id_12["LED_on"] = "127"
		self.atck_id_12["LED_off"] = "0"
		self.atck_id_12["LED_send_feedback_to_selected"] = ["midi_cc_ch_0_val_4"]
		self.atck_id_12["snap_to"] = True
		self.atck_id_12["json_id"] = 12
		self.atck_id_12["mapping_name"] = "ATCK"
		self.atck_id_12["mapping_type"] = "Parameter"
		self.rels_id_8 = {}
		self.rels_id_8["attached_to"] = "midi_cc_ch_0_val_5"
		self.rels_id_8["track"] = self.track_num(2)
		self.rels_id_8["module"] = "self.song().view.selected_track.devices[self.get_modifier_value(\"m1\")].parameters[5]"
		self.rels_id_8["element"] = "value"
		self.rels_id_8["output_type"] = "val"
		self.rels_id_8["minimum"] = round(0,2)
		self.rels_id_8["maximum"] = round(100,2)
		self.rels_id_8["decimal_places"] = 2
		self.rels_id_8["ui_listener"] = "value"
		self.rels_id_8["feedback_brain"] = "feedback_range"
		self.rels_id_8["ctrl_type"] = "absolute"
		self.rels_id_8["enc_first"] = 0
		self.rels_id_8["enc_second"] = 127
		self.rels_id_8["reverse_mode"] = False
		self.rels_id_8["takeover_mode"] = "Value scaling"
		self.rels_id_8["steps"] = 127
		self.rels_id_8["LED_mapping_type_needs_feedback"] = "1"
		self.rels_id_8["LED_feedback"] = "default"
		self.rels_id_8["LED_feedback_active"] = "1"
		self.rels_id_8["LED_on"] = "127"
		self.rels_id_8["LED_off"] = "0"
		self.rels_id_8["LED_send_feedback_to_selected"] = ["midi_cc_ch_0_val_5"]
		self.rels_id_8["snap_to"] = True
		self.rels_id_8["json_id"] = 8
		self.rels_id_8["mapping_name"] = "RELS"
		self.rels_id_8["mapping_type"] = "Parameter"
		self.arof_id_11 = {}
		self.arof_id_11["attached_to"] = "midi_cc_ch_0_val_6"
		self.arof_id_11["track"] = self.track_num(2)
		self.arof_id_11["module"] = "self.song().view.selected_track.devices[self.get_modifier_value(\"m1\")].parameters[6]"
		self.arof_id_11["element"] = "value"
		self.arof_id_11["output_type"] = "val"
		self.arof_id_11["minimum"] = round(0,2)
		self.arof_id_11["maximum"] = round(100,2)
		self.arof_id_11["decimal_places"] = 2
		self.arof_id_11["ui_listener"] = "value"
		self.arof_id_11["feedback_brain"] = "feedback_range"
		self.arof_id_11["ctrl_type"] = "absolute"
		self.arof_id_11["enc_first"] = 125
		self.arof_id_11["enc_second"] = 127
		self.arof_id_11["reverse_mode"] = False
		self.arof_id_11["takeover_mode"] = "None"
		self.arof_id_11["steps"] = 127
		self.arof_id_11["LED_mapping_type_needs_feedback"] = "1"
		self.arof_id_11["LED_feedback"] = "default"
		self.arof_id_11["LED_feedback_active"] = "1"
		self.arof_id_11["LED_on"] = "127"
		self.arof_id_11["LED_off"] = "0"
		self.arof_id_11["LED_send_feedback_to_selected"] = ["midi_cc_ch_0_val_6"]
		self.arof_id_11["snap_to"] = True
		self.arof_id_11["json_id"] = 11
		self.arof_id_11["mapping_name"] = "AROF"
		self.arof_id_11["mapping_type"] = "Parameter"
		self.expn_id_10 = {}
		self.expn_id_10["attached_to"] = "midi_cc_ch_0_val_7"
		self.expn_id_10["track"] = self.track_num(2)
		self.expn_id_10["module"] = "self.song().view.selected_track.devices[self.get_modifier_value(\"m1\")].parameters[3]"
		self.expn_id_10["element"] = "value"
		self.expn_id_10["output_type"] = "val"
		self.expn_id_10["minimum"] = round(0,2)
		self.expn_id_10["maximum"] = round(100,2)
		self.expn_id_10["decimal_places"] = 2
		self.expn_id_10["ui_listener"] = "value"
		self.expn_id_10["feedback_brain"] = "feedback_range"
		self.expn_id_10["ctrl_type"] = "absolute"
		self.expn_id_10["enc_first"] = 0
		self.expn_id_10["enc_second"] = 127
		self.expn_id_10["reverse_mode"] = False
		self.expn_id_10["takeover_mode"] = "Value scaling"
		self.expn_id_10["steps"] = 127
		self.expn_id_10["LED_mapping_type_needs_feedback"] = "1"
		self.expn_id_10["LED_feedback"] = "default"
		self.expn_id_10["LED_feedback_active"] = "1"
		self.expn_id_10["LED_on"] = "127"
		self.expn_id_10["LED_off"] = "0"
		self.expn_id_10["LED_send_feedback_to_selected"] = ["midi_cc_ch_0_val_7"]
		self.expn_id_10["snap_to"] = True
		self.expn_id_10["json_id"] = 10
		self.expn_id_10["mapping_name"] = "EXPN"
		self.expn_id_10["mapping_type"] = "Parameter"
		self.outg_id_21 = {}
		self.outg_id_21["attached_to"] = "midi_cc_ch_0_val_8"
		self.outg_id_21["track"] = self.track_num(2)
		self.outg_id_21["module"] = "self.song().view.selected_track.devices[self.get_modifier_value(\"m1\")].parameters[7]"
		self.outg_id_21["element"] = "value"
		self.outg_id_21["output_type"] = "val"
		self.outg_id_21["minimum"] = round(0,2)
		self.outg_id_21["maximum"] = round(100,2)
		self.outg_id_21["decimal_places"] = 2
		self.outg_id_21["ui_listener"] = "value"
		self.outg_id_21["feedback_brain"] = "feedback_range"
		self.outg_id_21["ctrl_type"] = "absolute"
		self.outg_id_21["enc_first"] = 0
		self.outg_id_21["enc_second"] = 127
		self.outg_id_21["reverse_mode"] = False
		self.outg_id_21["takeover_mode"] = "Value scaling"
		self.outg_id_21["steps"] = 127
		self.outg_id_21["LED_mapping_type_needs_feedback"] = "1"
		self.outg_id_21["LED_feedback"] = "default"
		self.outg_id_21["LED_feedback_active"] = "1"
		self.outg_id_21["LED_on"] = "127"
		self.outg_id_21["LED_off"] = "0"
		self.outg_id_21["LED_send_feedback_to_selected"] = ["midi_cc_ch_0_val_8"]
		self.outg_id_21["snap_to"] = True
		self.outg_id_21["json_id"] = 21
		self.outg_id_21["mapping_name"] = "OUTG"
		self.outg_id_21["mapping_type"] = "Parameter"
		self.make_id_20 = {}
		self.make_id_20["attached_to"] = "midi_cc_ch_0_val_9"
		self.make_id_20["track"] = self.track_num(2)
		self.make_id_20["module"] = "self.song().view.selected_track.devices[self.get_modifier_value(\"m1\")].parameters[8]"
		self.make_id_20["element"] = "value"
		self.make_id_20["output_type"] = "val"
		self.make_id_20["minimum"] = round(0,2)
		self.make_id_20["maximum"] = round(100,2)
		self.make_id_20["decimal_places"] = 2
		self.make_id_20["ui_listener"] = "value"
		self.make_id_20["feedback_brain"] = "feedback_range"
		self.make_id_20["ctrl_type"] = "absolute"
		self.make_id_20["enc_first"] = 124
		self.make_id_20["enc_second"] = 127
		self.make_id_20["reverse_mode"] = False
		self.make_id_20["takeover_mode"] = "None"
		self.make_id_20["steps"] = 127
		self.make_id_20["LED_mapping_type_needs_feedback"] = "1"
		self.make_id_20["LED_feedback"] = "default"
		self.make_id_20["LED_feedback_active"] = "1"
		self.make_id_20["LED_on"] = "127"
		self.make_id_20["LED_off"] = "0"
		self.make_id_20["LED_send_feedback_to_selected"] = ["midi_cc_ch_0_val_9"]
		self.make_id_20["snap_to"] = True
		self.make_id_20["json_id"] = 20
		self.make_id_20["mapping_name"] = "MAKE"
		self.make_id_20["mapping_type"] = "Parameter"
		self.dryw_id_7 = {}
		self.dryw_id_7["attached_to"] = "midi_cc_ch_0_val_10"
		self.dryw_id_7["track"] = self.track_num(2)
		self.dryw_id_7["module"] = "self.song().view.selected_track.devices[self.get_modifier_value(\"m1\")].parameters[9]"
		self.dryw_id_7["element"] = "value"
		self.dryw_id_7["output_type"] = "val"
		self.dryw_id_7["minimum"] = round(0,2)
		self.dryw_id_7["maximum"] = round(100,2)
		self.dryw_id_7["decimal_places"] = 2
		self.dryw_id_7["ui_listener"] = "value"
		self.dryw_id_7["feedback_brain"] = "feedback_range"
		self.dryw_id_7["ctrl_type"] = "absolute"
		self.dryw_id_7["enc_first"] = 0
		self.dryw_id_7["enc_second"] = 127
		self.dryw_id_7["reverse_mode"] = False
		self.dryw_id_7["takeover_mode"] = "Value scaling"
		self.dryw_id_7["steps"] = 127
		self.dryw_id_7["LED_mapping_type_needs_feedback"] = "1"
		self.dryw_id_7["LED_feedback"] = "default"
		self.dryw_id_7["LED_feedback_active"] = "1"
		self.dryw_id_7["LED_on"] = "127"
		self.dryw_id_7["LED_off"] = "0"
		self.dryw_id_7["LED_send_feedback_to_selected"] = ["midi_cc_ch_0_val_10"]
		self.dryw_id_7["snap_to"] = True
		self.dryw_id_7["json_id"] = 7
		self.dryw_id_7["mapping_name"] = "DRYW"
		self.dryw_id_7["mapping_type"] = "Parameter"
		self.modl_id_19 = {}
		self.modl_id_19["attached_to"] = "midi_cc_ch_0_val_11"
		self.modl_id_19["track"] = self.track_num(2)
		self.modl_id_19["module"] = "self.song().view.selected_track.devices[self.get_modifier_value(\"m1\")].parameters[10]"
		self.modl_id_19["element"] = "value"
		self.modl_id_19["output_type"] = "val"
		self.modl_id_19["minimum"] = round(0,2)
		self.modl_id_19["maximum"] = round(100,2)
		self.modl_id_19["decimal_places"] = 2
		self.modl_id_19["ui_listener"] = "value"
		self.modl_id_19["feedback_brain"] = "feedback_range"
		self.modl_id_19["ctrl_type"] = "absolute"
		self.modl_id_19["enc_first"] = 124
		self.modl_id_19["enc_second"] = 127
		self.modl_id_19["reverse_mode"] = False
		self.modl_id_19["takeover_mode"] = "None"
		self.modl_id_19["steps"] = 127
		self.modl_id_19["LED_mapping_type_needs_feedback"] = "1"
		self.modl_id_19["LED_feedback"] = "default"
		self.modl_id_19["LED_feedback_active"] = "1"
		self.modl_id_19["LED_on"] = "127"
		self.modl_id_19["LED_off"] = "0"
		self.modl_id_19["LED_send_feedback_to_selected"] = ["midi_cc_ch_0_val_11"]
		self.modl_id_19["snap_to"] = True
		self.modl_id_19["json_id"] = 19
		self.modl_id_19["mapping_name"] = "MODL"
		self.modl_id_19["mapping_type"] = "Parameter"
		self.scln_id_18 = {}
		self.scln_id_18["attached_to"] = "midi_cc_ch_0_val_13"
		self.scln_id_18["track"] = self.track_num(2)
		self.scln_id_18["module"] = "self.song().view.selected_track.devices[self.get_modifier_value(\"m1\")].parameters[14]"
		self.scln_id_18["element"] = "value"
		self.scln_id_18["output_type"] = "val"
		self.scln_id_18["minimum"] = round(0,2)
		self.scln_id_18["maximum"] = round(100,2)
		self.scln_id_18["decimal_places"] = 2
		self.scln_id_18["ui_listener"] = "value"
		self.scln_id_18["feedback_brain"] = "feedback_range"
		self.scln_id_18["ctrl_type"] = "absolute"
		self.scln_id_18["enc_first"] = 125
		self.scln_id_18["enc_second"] = 127
		self.scln_id_18["reverse_mode"] = False
		self.scln_id_18["takeover_mode"] = "None"
		self.scln_id_18["steps"] = 127
		self.scln_id_18["LED_mapping_type_needs_feedback"] = "1"
		self.scln_id_18["LED_feedback"] = "default"
		self.scln_id_18["LED_feedback_active"] = "1"
		self.scln_id_18["LED_on"] = "127"
		self.scln_id_18["LED_off"] = "0"
		self.scln_id_18["LED_send_feedback_to_selected"] = ["midi_cc_ch_0_val_13"]
		self.scln_id_18["snap_to"] = True
		self.scln_id_18["json_id"] = 18
		self.scln_id_18["mapping_name"] = "SCLN"
		self.scln_id_18["mapping_type"] = "Parameter"
		self.scon_id_17 = {}
		self.scon_id_17["attached_to"] = "midi_cc_ch_0_val_12"
		self.scon_id_17["track"] = self.track_num(2)
		self.scon_id_17["module"] = "self.song().view.selected_track.devices[self.get_modifier_value(\"m1\")].parameters[15]"
		self.scon_id_17["element"] = "value"
		self.scon_id_17["output_type"] = "val"
		self.scon_id_17["minimum"] = round(0,2)
		self.scon_id_17["maximum"] = round(100,2)
		self.scon_id_17["decimal_places"] = 2
		self.scon_id_17["ui_listener"] = "value"
		self.scon_id_17["feedback_brain"] = "feedback_range"
		self.scon_id_17["ctrl_type"] = "absolute"
		self.scon_id_17["enc_first"] = 125
		self.scon_id_17["enc_second"] = 127
		self.scon_id_17["reverse_mode"] = False
		self.scon_id_17["takeover_mode"] = "None"
		self.scon_id_17["steps"] = 127
		self.scon_id_17["LED_mapping_type_needs_feedback"] = "1"
		self.scon_id_17["LED_feedback"] = "default"
		self.scon_id_17["LED_feedback_active"] = "1"
		self.scon_id_17["LED_on"] = "127"
		self.scon_id_17["LED_off"] = "0"
		self.scon_id_17["LED_send_feedback_to_selected"] = ["midi_cc_ch_0_val_12"]
		self.scon_id_17["snap_to"] = True
		self.scon_id_17["json_id"] = 17
		self.scon_id_17["mapping_name"] = "SCON"
		self.scon_id_17["mapping_type"] = "Parameter"
		self.scgn_id_16 = {}
		self.scgn_id_16["attached_to"] = "midi_cc_ch_0_val_14"
		self.scgn_id_16["track"] = self.track_num(2)
		self.scgn_id_16["module"] = "self.song().view.selected_track.devices[self.get_modifier_value(\"m1\")].parameters[16]"
		self.scgn_id_16["element"] = "value"
		self.scgn_id_16["output_type"] = "val"
		self.scgn_id_16["minimum"] = round(0,2)
		self.scgn_id_16["maximum"] = round(100,2)
		self.scgn_id_16["decimal_places"] = 2
		self.scgn_id_16["ui_listener"] = "value"
		self.scgn_id_16["feedback_brain"] = "feedback_range"
		self.scgn_id_16["ctrl_type"] = "absolute"
		self.scgn_id_16["enc_first"] = 0
		self.scgn_id_16["enc_second"] = 127
		self.scgn_id_16["reverse_mode"] = False
		self.scgn_id_16["takeover_mode"] = "Value scaling"
		self.scgn_id_16["steps"] = 127
		self.scgn_id_16["LED_mapping_type_needs_feedback"] = "1"
		self.scgn_id_16["LED_feedback"] = "default"
		self.scgn_id_16["LED_feedback_active"] = "1"
		self.scgn_id_16["LED_on"] = "127"
		self.scgn_id_16["LED_off"] = "0"
		self.scgn_id_16["LED_send_feedback_to_selected"] = ["midi_cc_ch_0_val_14"]
		self.scgn_id_16["snap_to"] = True
		self.scgn_id_16["json_id"] = 16
		self.scgn_id_16["mapping_name"] = "SCGN"
		self.scgn_id_16["mapping_type"] = "Parameter"
		self.scmx_id_15 = {}
		self.scmx_id_15["attached_to"] = "midi_cc_ch_0_val_15"
		self.scmx_id_15["track"] = self.track_num(2)
		self.scmx_id_15["module"] = "self.song().view.selected_track.devices[self.get_modifier_value(\"m1\")].parameters[17]"
		self.scmx_id_15["element"] = "value"
		self.scmx_id_15["output_type"] = "val"
		self.scmx_id_15["minimum"] = round(0,2)
		self.scmx_id_15["maximum"] = round(100,2)
		self.scmx_id_15["decimal_places"] = 2
		self.scmx_id_15["ui_listener"] = "value"
		self.scmx_id_15["feedback_brain"] = "feedback_range"
		self.scmx_id_15["ctrl_type"] = "absolute"
		self.scmx_id_15["enc_first"] = 0
		self.scmx_id_15["enc_second"] = 127
		self.scmx_id_15["reverse_mode"] = False
		self.scmx_id_15["takeover_mode"] = "Value scaling"
		self.scmx_id_15["steps"] = 127
		self.scmx_id_15["LED_mapping_type_needs_feedback"] = "1"
		self.scmx_id_15["LED_feedback"] = "default"
		self.scmx_id_15["LED_feedback_active"] = "1"
		self.scmx_id_15["LED_on"] = "127"
		self.scmx_id_15["LED_off"] = "0"
		self.scmx_id_15["LED_send_feedback_to_selected"] = ["midi_cc_ch_0_val_15"]
		self.scmx_id_15["snap_to"] = True
		self.scmx_id_15["json_id"] = 15
		self.scmx_id_15["mapping_name"] = "SCMX"
		self.scmx_id_15["mapping_type"] = "Parameter"
	def _mode1_self_song_view_add_selected_track_listener_id_4(self):
		try:
			...
			self.log_message("csslog:(EC4 v0.2) There's a problem with 'Action Block 1' in reaction 'selectCompressor' (from 'Song - selected track' listener) >> ")
	...
	def _mode1_ui_listeners(self):
		try:
			self.deon_id_14_led = eval(self.deon_id_14["module"])
			self.deon_id_14_led.add_value_listener(self.deon_id_14_led_listener)
		except:
			self.log("_mode1_ui_listeners: " + str(self.deon_id_14["element"]) + " does not exist")
		try:
			self.thrs_id_6_led = eval(self.thrs_id_6["module"])
			self.thrs_id_6_led.add_value_listener(self.thrs_id_6_led_listener)
		except:
			self.log("_mode1_ui_listeners: " + str(self.thrs_id_6["element"]) + " does not exist")
		try:
			self.rati_id_9_led = eval(self.rati_id_9["module"])
			self.rati_id_9_led.add_value_listener(self.rati_id_9_led_listener)
		except:
			self.log("_mode1_ui_listeners: " + str(self.rati_id_9["element"]) + " does not exist")
		try:
			self.knee_id_13_led = eval(self.knee_id_13["module"])
			self.knee_id_13_led.add_value_listener(self.knee_id_13_led_listener)
		except:
			self.log("_mode1_ui_listeners: " + str(self.knee_id_13["element"]) + " does not exist")
		try:
			self.atck_id_12_led = eval(self.atck_id_12["module"])
			self.atck_id_12_led.add_value_listener(self.atck_id_12_led_listener)
		except:
			self.log("_mode1_ui_listeners: " + str(self.atck_id_12["element"]) + " does not exist")
		try:
			self.rels_id_8_led = eval(self.rels_id_8["module"])
			self.rels_id_8_led.add_value_listener(self.rels_id_8_led_listener)
		except:
			self.log("_mode1_ui_listeners: " + str(self.rels_id_8["element"]) + " does not exist")
		try:
			self.arof_id_11_led = eval(self.arof_id_11["module"])
			self.arof_id_11_led.add_value_listener(self.arof_id_11_led_listener)
		except:
			self.log("_mode1_ui_listeners: " + str(self.arof_id_11["element"]) + " does not exist")
		try:
			self.expn_id_10_led = eval(self.expn_id_10["module"])
			self.expn_id_10_led.add_value_listener(self.expn_id_10_led_listener)
		except:
			self.log("_mode1_ui_listeners: " + str(self.expn_id_10["element"]) + " does not exist")
		try:
			self.outg_id_21_led = eval(self.outg_id_21["module"])
			self.outg_id_21_led.add_value_listener(self.outg_id_21_led_listener)
		except:
			self.log("_mode1_ui_listeners: " + str(self.outg_id_21["element"]) + " does not exist")
		try:
			self.make_id_20_led = eval(self.make_id_20["module"])
			self.make_id_20_led.add_value_listener(self.make_id_20_led_listener)
		except:
			self.log("_mode1_ui_listeners: " + str(self.make_id_20["element"]) + " does not exist")
		try:
			self.dryw_id_7_led = eval(self.dryw_id_7["module"])
			self.dryw_id_7_led.add_value_listener(self.dryw_id_7_led_listener)
		except:
			self.log("_mode1_ui_listeners: " + str(self.dryw_id_7["element"]) + " does not exist")
		try:
			self.modl_id_19_led = eval(self.modl_id_19["module"])
			self.modl_id_19_led.add_value_listener(self.modl_id_19_led_listener)
		except:
			self.log("_mode1_ui_listeners: " + str(self.modl_id_19["element"]) + " does not exist")
		try:
			self.scln_id_18_led = eval(self.scln_id_18["module"])
			self.scln_id_18_led.add_value_listener(self.scln_id_18_led_listener)
		except:
			self.log("_mode1_ui_listeners: " + str(self.scln_id_18["element"]) + " does not exist")
		try:
			self.scon_id_17_led = eval(self.scon_id_17["module"])
			self.scon_id_17_led.add_value_listener(self.scon_id_17_led_listener)
		except:
			self.log("_mode1_ui_listeners: " + str(self.scon_id_17["element"]) + " does not exist")
		try:
			self.scgn_id_16_led = eval(self.scgn_id_16["module"])
			self.scgn_id_16_led.add_value_listener(self.scgn_id_16_led_listener)
		except:
			self.log("_mode1_ui_listeners: " + str(self.scgn_id_16["element"]) + " does not exist")
		try:
			self.scmx_id_15_led = eval(self.scmx_id_15["module"])
			self.scmx_id_15_led.add_value_listener(self.scmx_id_15_led_listener)
		except:
			self.log("_mode1_ui_listeners: " + str(self.scmx_id_15["element"]) + " does not exist")
	def _remove_mode1_ui_listeners(self):
		try:
			self.deon_id_14_led.remove_value_listener(self.deon_id_14_led_listener)
		except:
			self.log("remove__mode1_ui_listeners: " + str(self.deon_id_14["element"]) + " does not exist")
		try:
			self.thrs_id_6_led.remove_value_listener(self.thrs_id_6_led_listener)
		except:
			self.log("remove__mode1_ui_listeners: " + str(self.thrs_id_6["element"]) + " does not exist")
		try:
			self.rati_id_9_led.remove_value_listener(self.rati_id_9_led_listener)
		except:
			self.log("remove__mode1_ui_listeners: " + str(self.rati_id_9["element"]) + " does not exist")
		try:
			self.knee_id_13_led.remove_value_listener(self.knee_id_13_led_listener)
		except:
			self.log("remove__mode1_ui_listeners: " + str(self.knee_id_13["element"]) + " does not exist")
		try:
			self.atck_id_12_led.remove_value_listener(self.atck_id_12_led_listener)
		except:
			self.log("remove__mode1_ui_listeners: " + str(self.atck_id_12["element"]) + " does not exist")
		try:
			self.rels_id_8_led.remove_value_listener(self.rels_id_8_led_listener)
		except:
			self.log("remove__mode1_ui_listeners: " + str(self.rels_id_8["element"]) + " does not exist")
		try:
			self.arof_id_11_led.remove_value_listener(self.arof_id_11_led_listener)
		except:
			self.log("remove__mode1_ui_listeners: " + str(self.arof_id_11["element"]) + " does not exist")
		try:
			self.expn_id_10_led.remove_value_listener(self.expn_id_10_led_listener)
		except:
			self.log("remove__mode1_ui_listeners: " + str(self.expn_id_10["element"]) + " does not exist")
		try:
			self.outg_id_21_led.remove_value_listener(self.outg_id_21_led_listener)
		except:
			self.log("remove__mode1_ui_listeners: " + str(self.outg_id_21["element"]) + " does not exist")
		try:
			self.make_id_20_led.remove_value_listener(self.make_id_20_led_listener)
		except:
			self.log("remove__mode1_ui_listeners: " + str(self.make_id_20["element"]) + " does not exist")
		try:
			self.dryw_id_7_led.remove_value_listener(self.dryw_id_7_led_listener)
		except:
			self.log("remove__mode1_ui_listeners: " + str(self.dryw_id_7["element"]) + " does not exist")
		try:
			self.modl_id_19_led.remove_value_listener(self.modl_id_19_led_listener)
		except:
			self.log("remove__mode1_ui_listeners: " + str(self.modl_id_19["element"]) + " does not exist")
		try:
			self.scln_id_18_led.remove_value_listener(self.scln_id_18_led_listener)
		except:
			self.log("remove__mode1_ui_listeners: " + str(self.scln_id_18["element"]) + " does not exist")
		try:
			self.scon_id_17_led.remove_value_listener(self.scon_id_17_led_listener)
		except:
			self.log("remove__mode1_ui_listeners: " + str(self.scon_id_17["element"]) + " does not exist")
		try:
			self.scgn_id_16_led.remove_value_listener(self.scgn_id_16_led_listener)
		except:
			self.log("remove__mode1_ui_listeners: " + str(self.scgn_id_16["element"]) + " does not exist")
		try:
			self.scmx_id_15_led.remove_value_listener(self.scmx_id_15_led_listener)
		except:
			self.log("remove__mode1_ui_listeners: " + str(self.scmx_id_15["element"]) + " does not exist")
	def _mode1_fire_all_feedback(self):
		self.deon_id_14_led_listener()
		self.thrs_id_6_led_listener()
		self.rati_id_9_led_listener()
		self.knee_id_13_led_listener()
		self.atck_id_12_led_listener()
		self.rels_id_8_led_listener()
		self.arof_id_11_led_listener()
		self.expn_id_10_led_listener()
		self.outg_id_21_led_listener()
		self.make_id_20_led_listener()
		self.dryw_id_7_led_listener()
		self.modl_id_19_led_listener()
		self.scln_id_18_led_listener()
		self.scon_id_17_led_listener()
		self.scgn_id_16_led_listener()
		self.scmx_id_15_led_listener()
	def deon_id_14_led_listener(self):
		self.feedback_brain(self.deon_id_14)
	def thrs_id_6_led_listener(self):
		self.feedback_brain(self.thrs_id_6)
	def rati_id_9_led_listener(self):
		self.feedback_brain(self.rati_id_9)
	def knee_id_13_led_listener(self):
		self.feedback_brain(self.knee_id_13)
	def atck_id_12_led_listener(self):
		self.feedback_brain(self.atck_id_12)
	def rels_id_8_led_listener(self):
		self.feedback_brain(self.rels_id_8)
	def arof_id_11_led_listener(self):
		self.feedback_brain(self.arof_id_11)
	def expn_id_10_led_listener(self):
		self.feedback_brain(self.expn_id_10)
	def outg_id_21_led_listener(self):
		self.feedback_brain(self.outg_id_21)
	def make_id_20_led_listener(self):
		self.feedback_brain(self.make_id_20)
	def dryw_id_7_led_listener(self):
		self.feedback_brain(self.dryw_id_7)
	def modl_id_19_led_listener(self):
		self.feedback_brain(self.modl_id_19)
	def scln_id_18_led_listener(self):
		self.feedback_brain(self.scln_id_18)
	def scon_id_17_led_listener(self):
		self.feedback_brain(self.scon_id_17)
	def scgn_id_16_led_listener(self):
		self.feedback_brain(self.scgn_id_16)
	def scmx_id_15_led_listener(self):
		self.feedback_brain(self.scmx_id_15)	
	################## CORE: Python 3 #################
	...
	def disconnect(self):
		...
		super(css_ec4_v02, self).disconnect()